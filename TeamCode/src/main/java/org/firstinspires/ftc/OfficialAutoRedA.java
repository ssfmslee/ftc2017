...
@Autonomous
public class OfficialAutoRedA extends LinearOpMode {
            ...
            if(VuMark == "RIGHT"){
                ...
                while(numOfSpikes < 2&&opModeIsActive()){
                    ...
                    if(rangeSensor.getDistance(DistanceUnit.CM)<26){
                        while(rangeSensor.getDistance(DistanceUnit.CM)<26&&opModeIsActive()){
                       //empty
                        }
                         numOfSpikes++;
                    }
                ...
                while(numOfSpikes < 1&&opModeIsActive()){
                    ...
                    Motor3.setPower(0);
                    Timer.reset();
                    while(Timer.seconds()<1.2&&opModeIsActive()){ //seconds needs testing
                        Motor2.setPower(-0.1);
                        Motor1.setPower(0.1); //glyph goes in
                    }
                    Motor2.setPower(0);
