...
while(integratedZ>-5&&opModeIsActive()){
 ...
 while(integratedZ>-143&&opModeIsActive()){
  //notice that robot will stop rotation 5 degrees off from actual stop
  integratedZ = modernRoboticsI2cGyro.getIntegratedZValue();
  Motor3.setPower(-0.1);
 Motor4.setPower(-0.1);
 Motor2.setPower(-0.1);
 ...
 telemetry.update();
  ...
  //=============================================
 //spin 180
 while(integratedZ>-163&&opModeIsActive()){
  integratedZ = modernRoboticsI2cGyro.getIntegratedZValue();
 Motor3.setPower(-0.1);
 Motor4.setPower(-0.1);
 Motor2.setPower(-0.1);
 ...
 */
 ...
 while(Timer.seconds()<2.8&&opModeIsActive()){
  Motor4.setPower(0.1);
 Motor3.setPower(-0.1);
 ...
 while(rangeSensor.rawUltrasonic()>42){
 ...
 while(Timer.seconds()<0.17&&opModeIsActive()){
